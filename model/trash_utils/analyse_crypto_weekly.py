...
df['sent_impact'] = df['roberta_title_pos'] - df['roberta_title_neg'] + df['roberta_transcript_pos'] - df['roberta_transcript_neg']
...
ax2.set_ylabel('sentiment impact', color='tab:blue')  # we already handled the x-label with ax1
